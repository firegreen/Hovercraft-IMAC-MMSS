    ...
    if(collisionBetweenObject(o1,o2,&inter)){
        ...
        if(o1->life>0){
            for(i=0;i<o2->nbEffect;i++){
                setModifications(o2->effectsTypesAtCollision[i],o2->effectsAtCollision[i],
                                 o2->effectDelays[i],inter,o1);
            }
        }
        if(o2->life>0){
            //inter.normal1 = inter.normal2;
            for(i=0;i<o1->nbEffect;i++){
                setModifications(o1->effectsTypesAtCollision[i],o1->effectsAtCollision[i],
                                 o1->effectDelays[i],inter,o2);
            }
        }
        return 1;
    }
